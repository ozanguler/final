...
function select($day,$start_time) {
  ...
  $sql = "SELECT prof_eko_id,course_code,room_number FROM prof_schedule WHERE day='$day' && start_time='$start_time' && prof_eko_id=".$_SESSION['userSession'];
...
<button id="datasil">
<a href="profEditSchedule.php">Edit Schedule</a>
</button>
